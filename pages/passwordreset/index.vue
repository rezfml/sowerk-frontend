        ...
        <v-col>
          <v-card class="d-flex flex-column align-center" style="width: 100%">
            ...
            <v-img  v-else class="mb-n16 " style="position:relative;" max-height="350" max-width="300" src="https://sowerk-images.s3.us-east-2.amazonaws.com/SoWork+Logo-143.png"/>
              ...
              <v-card-title class="mt-n16">Forgot Your Keys? We Do It Too.</v-card-title>
              <v-card-subtitle>Please enter your email account, and we will send an email to the address you entered with instructions to reset your password!</v-card-subtitle>
              ...
              <v-container v-else >
              <v-card-title class="mt-n16" style="width:100%;font-size:1rem">Forgot Your Keys? We Do It Too.</v-card-title>
              <v-card-subtitle style="font-size:.75em">Please enter your email account, and we will send an email to the address you entered with instructions to reset your password!</v-card-subtitle>
