<template>
  <v-img
    class="fill-height"
    src="https://images.unsplash.com/photo-1530124566582-a618bc2615dc?ixlib=rb-1.2.1&q=80&fm=jpg&crop=entropy&cs=tinysrgb&w=1080&fit=max&ixid=eyJhcHBfaWQiOjF9"
    gradient="to top, rgba(0,0,0,0.6), rgba(0,0,0,0.7)"
  >
              ...
              <v-card rounded style="border: 5px solid #A61C00; border-radius: 20px;">
                ...
                <v-card-text>
                  <v-row>
                    ...
                    <v-col cols="12">
                      <p class="text-center mx-auto mt-4 text-h1" style="max-width: 350px">If you have one property or thousands of assets and would like to manage approved vendors.</p>
                    </v-col>
