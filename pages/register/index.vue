          ...
          <v-row v-if="!$vuetify.breakpoint.xs && !$vuetify.breakpoint.sm ">
            <v-col cols="12" md="6" style="max-width:45%;margin:2.5%">
              <v-card rounded style="box-shadow:0 0 0 5px #A61C00; border-radius: 30px;">
                <v-card-title><p class="mx-auto text-center">Property & Facility Managers</p></v-card-title>
                <v-card-text style="border-radius: 30px;">
                  <v-row>
                    ...
                    <v-col cols="12">
                      <p class="text-center mx-auto mt-4" style="max-width: 350px; font-size:2vh">If you have one property or thousands of assets and would like to manage approved vendors.</p>
                    </v-col>
            ...
            <v-col cols="12" md="6" style="max-width:45%;margin:2.5%">
              <v-card rounded style="box-shadow:0 0 0 5px #A61C00; border-radius: 30px;">
                <v-card-title><p class="mx-auto text-center">Service Providers</p></v-card-title>
                <v-card-text>
                  <v-row>
                    <v-col class="mx-auto text-center" cols="12">
              ...
              <v-card rounded style="box-shadow:0 0 0 5px #A61C00; border-radius: 30px;">
                ...
                <v-card-text style="border-radius: 30px;">
                  <v-row>
                    ...
                    <v-col cols="12">
                      <p class="text-center mx-auto mt-4" style="max-width: 350px">If you have one property or thousands of assets and would like to manage approved vendors.</p>
                    </v-col>
