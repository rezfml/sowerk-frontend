    ...
    <v-container class="d-flex flex-column align-center" fluid id="v-step-0" style="width: 100%;">
      ...
      <transition name="slide-fade">
        <v-row style="width: 100%;" class="mt-n16 d-flex justify-center" v-if="company && company.company_type !== 'false'">
          ...
          <v-col cols="12" xl="4" lg="4" md="10" sm="12" style="height:auto;" v-if="!$vuetify.breakpoint.sm && !$vuetify.breakpoint.xs && !$vuetify.breakpoint.md">
            <v-card style="width: 100%; height: 50vh;" class="d-flex flex-column align-center justify-center" v-if="this.$vuetify.breakpoint.height > 925">
          ...
          <v-col cols="12" xl="4" lg="4" md="10" sm="12" style="height: auto;" v-if="!$vuetify.breakpoint.sm && !$vuetify.breakpoint.xs && !$vuetify.breakpoint.md">
            <v-card  v-if="this.$vuetify.breakpoint.height > 925" style="width: 100%; height: 50vh;" class="d-flex flex-column align-center justify-center">
              <v-row style="width: 100%;" class="mt-16">
          ...
          <!-- VENDOR SEARCH CARD -->
          <v-col cols="12" xl="4" lg="4" md="10" sm="12" style="height: auto;" v-if="!$vuetify.breakpoint.sm && !$vuetify.breakpoint.xs && !$vuetify.breakpoint.md">
            <v-card  v-if="this.$vuetify.breakpoint.height > 925" style="width: 100%; height: 50vh;" class="d-flex flex-column align-center">
              <v-row style="width: 100%;" class="mt-16">
            ...
            <v-card v-else style="width: 100%; height: 60vh;" class="d-flex flex-column align-center">
              <v-row style="width: 100%;" class="mt-16">
                <v-img width="400px" height="75px" src="/SoWork Logos with Icons-172.png"></v-img>
              </v-row>
              <v-card-text style="font-size: 18px;text-align:center; margin-top: 10%;">Once your channels are established and Vendor applications published it's time to find Vendors to apply.</v-card-text>
          ...
          <v-col cols="12" xl="4" lg="4" md="10" sm="12" class="mt-6" v-if="!$vuetify.breakpoint.sm && !$vuetify.breakpoint.xs && !$vuetify.breakpoint.md">
            <v-card v-if="this.$vuetify.breakpoint.height > 925" style="width: 100%; height: 30vh; background-color: #7C7C7C; color: white;" class="d-flex flex-column align-center justify-center">
            ...
            <v-card v-else style="width: 100%; height: 60vh; background-color: #7C7C7C; color: white;" class="d-flex flex-column align-center justify-center">
              <v-card-title class="mt-2" style="text-align: center; font-size: 3rem;">SOWERK 101</v-card-title>
              <v-card-text class="my-2" style="color: white; text-align: center; font-size: 1.5rem; line-height: 1.75rem">Check out the SOWerk 101 knowledge center for support</v-card-text>
              <v-btn outlined to="/dashboard/feedback/sowerkInfo/" color="white" class="py-8 my-2 mb-4" style="width: 90%; border-radius: 10px;">View All</v-btn>
            </v-card>
          ...
          <v-col cols="12" xl="8" lg="8" md="10" sm="12" style="height: auto;" class="mt-6"  v-if="!$vuetify.breakpoint.sm && !$vuetify.breakpoint.xs && !$vuetify.breakpoint.md">
            <v-card style="width: 100%; height: 30vh;" class="d-flex align-center" v-if="this.$vuetify.breakpoint.height > 925">
            ...
            <v-card style="width: 100%; height: 60vh;" class="d-flex flex-column align-center" v-else>
              <v-col class="d-flex flex-column align-center mb-n16" cols="9">
                <v-row style="width:100%" class="d-flex justify-center">
                  <img src="/SoWork Logos with Icons-173-edited.png" style="width: 350px;height:200px;">
                </v-row>
              </v-col>
              <v-row style="width: 100%;" class="d-flex justify-center mt-n16">
                <v-col v-for="(stat, index) in stats" cols="4">
                  <transition name="slide-fade">
                    <StatCard :key="index" v-if="statApproved" :stat="stat"></StatCard>
                  </transition>
                </v-col>
