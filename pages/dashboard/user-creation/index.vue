  ...
  export default {
    ...
    data() {
      return {
        ...
        locations: [],
        headers: [
          { text: 'Name', value: 'first_name', filterable: true, class: 'primary--text font-weight-bold text-h6 text-left text-justify-start' },
          { text: 'Admin Level', value: 'useradmin', class: 'primary--text font-weight-bold text-h6 text-left text-justify-start' },
          { text: 'Location Access', value: 'locationAccess', class: 'primary--text font-weight-bold text-h6 text-left text-justify-start'},
          { text: 'Email', value: 'email', filterable: true, class: 'primary--text font-weight-bold text-h6 text-left text-justify-start' },
          { text: 'Phone', value: 'phone', filterable: true, class: 'primary--text font-weight-bold text-h6 text-left text-justify-start' },
          { text: 'Created', value: 'usercreated', class: 'primary--text font-weight-bold text-h6 text-left text-justify-start' },
          { text: 'Accepted Invite', value: 'userverify', class: 'primary--text font-weight-bold text-h6 text-left text-justify-start'},
          { text: 'Actions', value: 'useractions', class: 'primary--text font-weight-bold text-h6 text-left text-justify-start' },
        ],
        headersMobile: [
          { text: 'Name', value: 'first_name', filterable: true, class: 'primary--text font-weight-bold text-h6 text-left text-justify-start' },
          { text: 'Actions', value: 'useractions', class: 'primary--text font-weight-bold text-h6 text-left text-justify-start' },
