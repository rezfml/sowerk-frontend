  ...
  export default {
    ...
    methods: {
      ...
      async submit() {
        ...
        let {data, status} = await this.$http.post('http://node-express-env.eba-vhau3tcw.us-east-2.elasticbeanstalk.com/api/locations/byUserId/' + this.currentUser.id, this.form).catch(e => e);
        console.log(data);
      }
    }
  }
