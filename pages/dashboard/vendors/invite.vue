  ...
  export default {
    ...
    data() {
      return {
        ...
        services: [],
        headers: [
          { text: 'Vendor', value: 'service', class: 'primary--text text-h6 font-weight-bold text-left' },
          { text: 'Company', value: 'companyName', class: 'primary--text text-h6 font-weight-bold text-left' },
          { text: 'First Name', value: 'firstName', class: 'primary--text text-h6 font-weight-bold text-left' },
          { text: 'Last Name', value: 'lastName', class: 'primary--text text-h6 font-weight-bold text-left' },
          ...
          { text: 'Pre-Approved', value: 'preapproved', class: 'primary--text text-h6 font-weight-bold text-left' },
          { text: 'Channel', value: 'property', class: 'primary--text text-h6 font-weight-bold text-left' },
        ],
        businesses: null,
        success: false
      }
