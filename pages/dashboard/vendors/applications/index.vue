    ...
    data () {
      return {
        ...
        headersApplicationTemplateVal: [
          { text: 'Application Name', value: 'name', class: 'primary--text text-h6 font-weight-bold text-left' },
          { text: 'Category', value: 'service', class: 'primary--text text-h6 font-weight-bold text-left' },
          { text: 'Channel Name', value: 'locationName', class: 'primary--text text-h6 font-weight-bold text-left' },
          { text: 'Channel Address', value: 'locationAddress', class: 'primary--text text-h6 font-weight-bold text-left' },
          { text: '#Questions', value: 'formfields', class: 'primary--text text-h6 font-weight-bold text-left' },
          { text: 'Application Status', value: 'applicationStatus', class: 'primary--text text-h6 font-weight-bold text-left' },
        ...
        companyDocumentsHeaders: [
          { text: 'Document Name', value: 'documentName', class: 'primary--text text-h6 font-weight-bold text-left'},
          { text: 'Upload Date', value: 'created', class: 'primary--text text-h6 font-weight-bold text-left'},
          { text: 'Actions', value: 'actions', sortable: false, class: 'primary--text text-h6 font-weight-bold text-left' },
        ],
        addLocations: [
