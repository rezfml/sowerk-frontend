<template>
  <v-container style="width: 100%;" overflow-y-auto>
    ...
    <div
      style="position: fixed; width: 100%; height: 100vh; display: flex; justify-content: center; align-items: center; z-index: 100; background-color: rgba(0,0,0,0.2); top: 0; left: 0;"
    ...
    <transition name="slide-fade">
      <v-card class="my-4 flex-row justify-space-between align-center mx-0">
        <v-row
          class="d-flex flex-row justify-space-between align-center mx-0"
          style="width:100%;height:auto; background-color: #707070"
        >
          <v-col cols="3" style="color:white;width:100%;text-align:center;">
            <h1
              style="letter-spacing:5px;font-weight:450;font-style:italic;font-size:2.8rem;padding-left:2%;color:white"
            >
              SOWERK 101
            </h1>
          </v-col>
          ...
          <v-col
            cols="5"
            style="color:white;width:100%;text-align:left;padding-left:2%;padding-top:2%"
          >
            <p style="font-size:1.1rem">
              Watch our short video to learn about Vendor Requirements and why
              they are important to your SOWerk Account.
            </p>
          </v-col>
          ...
          <v-col
            ...
            v-if="videosLinks.vendorApplications === true"
          >
            <v-btn
              @click="watchClickedVendorApplications"
              color="white"
              outlined
            ...
            >
              <span
                style="font-size:1rem;letter-spacing:3px;font-weight:400;color:white;text-align:center;"
              >
                WATCH NOW <br />
                -Vendor Applications-
              </span>
          ...
          <v-col
            cols="4"
            style="width:100%;text-align:center;"
            v-if="videosLinks.companyDocuments === true"
          >
            <v-btn
              @click="watchClickedCompanyDocuments"
              color="white"
              outlined
              style="width: 80%; border-radius: 20px;"
              class="py-8"
          ...
          <v-col
            cols="4"
            style="width:100%;text-align:center;"
            v-if="videosLinks.companyTemplates === true"
          >
            <v-btn
              @click="watchClickedCompanyTemplates"
              color="white"
              outlined
              style="width: 80%; border-radius: 20px;"
              class="py-8"
          ...
          <v-col
            cols="4"
            style="width:100%;text-align:center;"
            v-if="videosLinks.sowerkTemplates === true"
          >
            <v-btn
              @click="watchClickedSowerkTemplates"
              color="white"
              outlined
              style="width: 80%; border-radius: 20px;"
              class="py-8"
    ...
    <transition name="slide-fade">
      <v-card
        style="height:550px;width:100%;background-color:#404040;border-radius:10px;"
        v-if="clickedLinks.vendorApplications === true"
      >
        <div style="border-radius:10px;">
          <iframe
            src="https://vimeo.com/showcase/7955326/embed"
            allowfullscreen
            frameborder="0"
      ...
      <v-card
        style="height:550px;width:100%;background-color:#404040;border-radius:10px;"
        v-if="clickedLinks.companyTemplates === true"
      >
        <div style="border-radius:10px;">
          <iframe
            src="https://player.vimeo.com/video/495537809"
            allowfullscreen
            frameborder="0"
            style="width:100%;height:550px;border-radius:10px;"
          >
      ...
      <v-card
        style="height:550px;width:100%;background-color:#404040;border-radius:10px;"
        v-if="clickedLinks.sowerkTemplates === true"
      >
        <div style="border-radius:10px;">
          <iframe
            src="https://player.vimeo.com/video/495537767"
            allowfullscreen
            frameborder="0"
            style="width:100%;height:550px;border-radius:10px;"
          >
    ...
    <transition name="slide-fade">
      <v-card
        class="mt-4"
        style="width: 100%; height: auto; background-image: url('/tools-texture.png'); background-size: cover; background-position: bottom;"
        v-if="loading"
      >
        <v-row
          style="width: 100%; height: auto;margin-bottom:5%"
          class="d-flex flex align-center"
        >
          <v-col cols="7" style="">
            <v-img
              height="400px"
              src="/SoWork Logos with Icons-159.png"
            ></v-img>
          </v-col>
          ...
          <v-col cols="5" class="d-flex flex-column justify-center">
            <v-row>
              ...
              <p class="mt-4">
                Vetted Vendors get the job done right, and SOWerk is designed to
                give you the power to ensure every vendor or supplier meets your
                requirements. Through this interface, you can build an approved
                Vendor application specific to a service or supplier category,
                turn applications on or off, and even customize any application
            ...
            <v-row>
              <v-col cols="12" class="d-flex flex-column">
                <v-btn
                  @click="loadApplicationLocationsFunction"
                  class="py-4 mb-3"
                  color="primary"
                ...
                >
                  <v-img
                    src="/resume-icon.svg"
                    style="max-height:50px;max-width:50px;padding:5%;"
                  ></v-img>
            ...
            <v-row>
              <v-col cols="6" class="d-flex flex-column">
                <v-btn
                  @click="loadYourCompanyTemplatesFunction"
                  class="py-4 mb-3"
                  color="primary"
                  style="width:100%;height:70px;border-radius:5px;justify-content:space-around;"
                >
                  <span>
                    <span
                      ><v-img
              ...
              <v-col cols="6" class="d-flex flex-column">
                <v-btn
                  @click="loadApplicationTemplatesFunction"
                  class="py-4 mb-3"
                  color="#707070"
                  style="width:100%;height:70px;border-radius:5px;justify-content:space-around;"
                >
    ...
    <transition name="slide-fade">
      <v-card
        ...
        v-if="loadYourCompanyTemplates || loadApplicationTemplates"
      >
        <p
          class="mt-4"
          style="color: #A61C00; width: 80%; text-align: center; word-break: break-word;"
        >
          Tip* A quick way to build a Vendor Application or Company Template is
          to start with a SOWerk Template that provides more of your desired
          questions (i.e. “General Questions” template). Then, once added to
          Company Templates or Assigned Channel you simply find this new item
          and choose Edit where you can add more questions.
        </p>
      </v-card>
    </transition>
    ...
    <transition name="slide-fade">
      <v-card
        class="d-flex justify-center mt-n16"
        v-if="loadApplicationLocations"
      >
        <p
          class="mt-4"
          style="color: #A61C00; width: 80%; text-align: center; word-break: break-word;"
        >
          Tip* If you have multiple Channels that will vet Vendors in a similar
          manner, rather than build a single application for each of those
          Channels try building a Company Template first. Company Templates can
          be assigned to multiple channels. Then, if you need to customize the
          application at just one of your channels you can do so without
          affecting the original Company Template or any other channel that uses
          said template.
        </p>
      </v-card>
    </transition>
    ...
    <transition name="slide-fade">
      <v-card class="mt-8" v-if="loadApplicationLocations && loading">
        <v-card-title
          class="mb-8"
          style="color: white; background-color: #a61c00; width: 50%; text-align: center; position: absolute; left: 10px; top: -20px; border-radius: 10px;"
          >Your Vendor Applications</v-card-title
        >
        <v-btn
          @click="addNewVendorFormLoading"
          class="py-6 mb-2"
          color="primary"
          style="position: absolute; right: 10px; top: -20px; width: 30%; z-index: 1;"
          ><v-icon>mdi-plus</v-icon>Add New Vendor Form</v-btn
        >
        <template v-if="loading">
          ...
          >
                      ...
                      <tr v-for="app in item.userforms" :key="app.id">
                        ...
                        <td v-if="app !== 'There are no userforms'">
                          <v-btn
                            class="my-1"
                            color="#707070"
                            :to="'/dashboard/vendors/applications/' + app.id"
                            style="color: white; width: 20%;"
                            >Edit</v-btn
                          >
                          <v-btn
                            @click="deleteUserForm(app)"
                            class="my-1"
                            color="primary"
                            style="width: 20%;"
                            >Delete</v-btn
            ...
            <template v-slot:item.userforms="{ item }">
              ...
              <p v-else-if="item.userforms[0] !== 'There are no userforms'">
                {{ item.userforms.length }}
              </p>
            </template>
          </v-data-table>
        </template>
    ...
    <transition name="slide-fade">
      <v-card
        class="mt-16"
        v-if="loadApplicationTemplates"
        style="width: 100%;"
      >
        <v-card-title
          class="mb-8"
          style="color: white; background-color: #a61c00; width: 50%; text-align: center; position: absolute; left: 10px; top: -20px; border-radius: 10px;"
          >SOWerk Application Templates</v-card-title
        >
          ...
          >
                ...
                <v-simple-table fixed-header height="300px">
                  <template v-slot:default>
                    ...
                    <tbody>
                      <tr
                        v-for="(app,
                        index) in item.applicationtemplatesformfields"
                        :key="app.name"
                      >
            ...
            <template v-slot:item.actions="{ item }">
              <div class="d-flex" v-if="$vuetify.breakpoint.xl">
                <v-btn
                  @click="addtoLocationLoad(item)"
                  class="mx-2"
                  color="#707070"
                  style="color:white; width: 45%;"
                  >Assign Channel</v-btn
                >
                <v-btn
                  @click="addToCompanyTemplates(item)"
                  class="mx-2"
                  color="primary"
                  style="width: 53%;"
                  >Add to Company Templates</v-btn
                >
              </div>
              <v-btn
                v-if="
                ...
                class="mx-6 my-1"
                color="#707070"
                style="color:white; width: 80%;font-size:.9rem;letter-spacing:1px;"
                >Assign Channel</v-btn
              >
              <v-btn
                v-if="
                ...
                class="mx-6 my-1"
                color="primary"
                style="width: 80%;font-size:.9rem;letter-spacing:1px;"
                >Add to Company Templates</v-btn
              >
            </template>
          </v-data-table>
    ...
    <transition name="slide-fade">
      <v-card class="mt-16" v-if="loadYourCompanyTemplates">
        <v-card-title
          class="mb-8"
          style="color: white; background-color: #a61c00; width: 50%; text-align: center; position: absolute; left: 10px; top: -20px; border-radius: 10px;"
          >Company Approved Templates</v-card-title
        >
        <v-btn
          v-if="currentUser.is_superuser"
          @click="addNewCompanyTemplateLoading"
          class="py-6 mb-2"
          color="primary"
          style="position: absolute; right: 10px; top: -20px; width: 25%;"
          ><v-icon>mdi-plus</v-icon>Add New Template</v-btn
        >
        <template v-if="loading" style="width: 100%;">
          <v-data-table
            :headers="headers"
          ...
          >
              ...
              <td :colspan="headers.length">
                <v-simple-table fixed-header height="300px">
                  <template v-slot:default>
                    ...
                    <tbody>
                      <tr
                        v-for="(app, index) in item.companytemplatesformfields"
                        :key="app.name"
                      >
                        <td>Question# {{ index + 1 }}</td>
                        <td>{{ app.name }}</td>
            ...
            >
              ...
              >
                <v-btn
                  :to="'/dashboard/vendors/companytemplates/' + item.id"
                  class="mx-2 my-2"
                  style="width: 80%;"
                  v-if="currentUser.is_superuser"
                  >Edit</v-btn
                ...
                >
                <v-btn
                  @click="deleteCompanyTemplates(item)"
                  class="mx-2 my-2"
                  color="primary"
                  style="width: 80%;"
                  v-if="currentUser.is_superuser"
      ...
      <v-row class="mt-8" v-if="loadYourCompanyDocuments">
        <v-col cols="6">
          <v-card>
            <v-card-title
              class="mb-8"
              style="color: white; background-color: #a61c00; width: 90%; text-align: center; position: absolute; left: 10px; top: -20px; border-radius: 10px;"
              >Add New Documents</v-card-title
            >
            <v-card-text class="pt-16 ml-4"
              >Upload any company document or template that you will use to
              share with vendors to download, complete, and upload to SOWerk.
              Common items include master service agreements, independent
              contractor agreements, nondisclosure agreements, and tax
              examples.</v-card-text
            >
            <v-btn
              @click="clickCompanyDocumentsImageUpload"
              color="primary"
              large
              outlined
              rounded
              style="width: 70%;"
              class="py-4 px-16 mb-16 ml-4"
              >Upload <v-icon>mdi-plus</v-icon></v-btn
            >
            <v-file-input
              class="location-image-upload ma-0 pa-0"
              :class="{
                'location-image-upload--selected': companyDocument.documentUrl
              }"
              v-model="companyDocument.documentUrl"
              v-on:change.native="selectCompanyDocumentsImage"
              id="companyDocumentImage"
              style="display: none;"
            ></v-file-input>
          </v-card>
        </v-col>
        <v-col cols="6">
          <v-card>
            <v-card-title
              class="mb-8"
              style="color: white; background-color: #a61c00; width: 90%; text-align: center; position: absolute; left: 10px; top: -20px; border-radius: 10px;"
              >Currently Listed Company Documents</v-card-title
            >
            <v-data-table
              class="pt-16"
            ...
            >
              <template
                v-slot:item.created="{ item, index }"
                class="d-flex flex-column align-center"
              >
              ...
              >
                <v-btn
                  @click="deleteCompanyDocument(item, index)"
                  color="primary"
                  class="my-1"
                  style="width: 80%;"
                  v-if="currentUser.is_superuser"
    ...
    <transition name="slide-fade">
      <v-card
        style="box-shadow: 4px 4px 4px grey; border: 1px solid grey; position:fixed; top: 15vh; left: 20vw; width: 78vw; height: auto;"
        v-if="addToVendorLoad"
        class="d-flex flex-column align-center"
      >
        <v-card-title
          class="mb-8"
          style="color: white; background-color: #a61c00; width: 90%; text-align: center; position: absolute; left: 10px; top: -20px; border-radius: 10px;"
          >Choose Vendor, then Channel</v-card-title
        >
        <v-autocomplete
        ...
        >
          <template slot="selection" slot-scope="data">
            <p @click="getChannelsForVendor(data.item)" style="width: 100%;">
        ...
        >
          <template slot="selection" slot-scope="data">
            <p
              @click="addChannelToVendorDocList(data.item)"
              style="width: 100%;"
            >
        ...
        <v-btn
          style="position: absolute; bottom: 15px; left: 20px; width: 20%;"
          class="py-6 px-16"
          color="primary"
          @click="backToCompanyDocuments"
          >< BACK</v-btn
        >
        <v-btn
          style="width: 40%;"
          class="my-2"
          color="primary"
          @click="sendToVendorDocs"
          >Send To Vendor(s)</v-btn
        >
        <v-card-text
          class="my-2"
          style="text-align: center; color: #A61C00;"
          v-if="loadingSubmitVendorDocsSuccess"
          >Success in sending document to vendor!</v-card-text
        >
      </v-card>
    </transition>
    ...
    <transition name="slide-fade">
      <v-card
        style="box-shadow: 4px 4px 4px darkred; border: 1px solid #A61C00; position:absolute; top: 15vh; width: 80vw; height: auto;"
        v-if="addToLocationLoad"
      >
        <transition name="slide-fade">
          <v-card-title
        ...
        <transition name="slide-fade">
          <v-card-title
            v-if="!loadChannelList && loadAssignTagCategoryType"
            class="mb-8"
            style="color: white; background-color: #a61c00; width: 70%; text-align: center; position: absolute; left: 10px; top: -20px; border-radius: 10px;"
            >Choose your Type, Category, and Tags</v-card-title
          >
        </transition>
        <template v-if="loading">
          <transition name="slide-fade">
          ...
          <transition name="slide-fade">
            ...
            >
              ...
              <template v-slot:item.actions="{ item }">
                <v-btn
                  @click="assignToService(item.id)"
                  class="my-1"
                  color="#707070"
                  style="color: white; width: 100%;"
                  >Assign Template</v-btn
                >
              </template>
            </v-data-table>
          </transition>
          <transition name="slide-fade">
            <v-row
              v-if="!loadChannelList && loadAssignTagCategoryType"
              class="mt-12 d-flex flex-column align-center"
            >
              <v-card-title
                class="d-flex justify-left ml-2"
                style="width: 100%;"
                ><span class="ml-2" style="color:#a61c00;"
                  >SOWerk Application Name:</span
                ></v-card-title
              >
              <v-text-field
                style="width: 95%;"
              ...
              >
                <template v-slot:selection="data">
                  <v-chip class="v-chip--select-multi" style="width: auto;">
                    <v-card-text v-if="data.item.name">{{
                      data.item.name
                    }}</v-card-text>
                    <v-card-text v-else>{{ data.item }}</v-card-text>
                    <v-btn @click="removeTag(data.item)" text class="ml-n6"
                      >X</v-btn
                    >
                  </v-chip>
                </template>
              ...
              <v-btn
                @click="submitTagCategoryType(item)"
                class="my-4 py-6 mr-8"
                color="#7C7C7C"
                style="color:white; width: 40%; align-self: flex-end"
                v-if="!submittedOnce"
                >Submit</v-btn
              >
              <v-card-text
                class="my-4 py-3 mr-8"
                color="#707070"
                style="color:white; width: 30%; margin-left:40%; font-size: 1.1rem; text-align:center; font-weight: 500; border:1px solid white;border-radius:20px; background-color:#707070;"
                v-if="submittedOnce && submissionSuccess"
                >Your information has been submitted!</v-card-text
              >
            </v-row>
          </transition>
        </template>
        <v-btn
          text
          @click="closeAddToLocationLoad"
          style="position: absolute; top: 10px; right: 10px; font-size: 30px;"
          >X</v-btn
        >
        <v-btn
          style="position: absolute; bottom: 15px; left: 20px; width: 40%;"
          class="py-6 px-16"
          color="primary"
          @click="backAssignTagCategoryType"
          v-if="loadAssignTagCategoryType"
          >< BACK</v-btn
        >
      </v-card>
    </transition>

    <!-- BEGINNING OF FORM BUILDER AREA -->
    <transition name="slide-fade">
      <v-card v-if="addNewCompanyTemplateLoad" class="mt-12 d-flex flex-column">
        <v-card-title
          class="mb-10"
          style="color: white; background-color: #a61c00; width: 50%; text-align: center; position: absolute; left: 10px; top: -20px; border-radius-top-left: 20px; border-radius-top-right: 20px;"
          >Add New Company Template</v-card-title
        >
        <transition name="slide-fade">
          <v-card-title
            v-if="step4"
            class="my-10 mt-14"
            style="position: absolute; left: 10px; text-align: center; width: 80%; color: white; background-color: #a61c00; border-radius-bottom-left: 20px; border-radius-bottom-right: 20px;"
            >Step 1 - Enter your form name in the upper left. Step 2 - Then,
            drag and drop questions and edit them to your liking. Step 3 - hit
            submit!</v-card-title
          >
        </transition>
        <transition name="slide-fade">
          <v-container
            class="py-16 mt-16"
            overflow-y-auto
            v-if="addNewCompanyTemplateLoad"
          >
            <v-row
              v-if="loading"
              class="d-flex justify-center wrap-row"
              style="width: 100%;"
            >
              <v-btn
                v-if="saveLoad"
                @click="saveCompanyTemplate"
                style="width: 45%;"
                color="primary"
                rounded
                class="mt-n6 mb-2 mx-2 py-8"
                >Save</v-btn
              >
              <v-progress-circular
                v-if="saveLoad === false"
              ...
              ></v-progress-circular>
              <v-btn
                :href="'https://www.sowerk.com/dashboard/vendors/applications'"
                style="width: 45%;"
                color="#707070"
                rounded
                outlined
                class="mt-n6 mb-2 mx-2 py-8"
                >Go Back To All Applications</v-btn
              >
            </v-row>
            ...
            <v-row class="d-flex justify-center" style="width: 100%;">
              <v-col cols="6" class="d-flex flex-column align-center">
                <v-card
                  ...
                  style="width: 100%;"
                >
                  <v-card-title style="color: #A61C00; text-align: center"
                    >Your Application</v-card-title
                  >
                  <v-card-subtitle style="text-align: center"
                    >This column represents your questions being asked of a
                    Vendor. You can reorder and edit any question.
                  </v-card-subtitle>
                  <v-row
                    style="width: 98%; border: 1px solid #151515; box-shadow: 4px 4px 4px #7C7C7C; border-radius: 5px;"
                    class="d-flex flex-column align-center"
                  >
                    <v-card-title
                      class="d-flex justify-left"
                      style="width: 100%;"
                      ><span class="mr-2" style="">Application Name:</span
                      ><span
                        style="color: #7C7C7C; white-space: pre-wrap; word-break: break-word;"
                        >(A Good Name Helps You & Vendors - i.e. Commercial
                        Cleaning - Dexter IA)</span
                      ></v-card-title
                    >
                    <v-text-field
                      style="width: 95%;"
                      clearable
                      label="Enter Form Name Here"
                      v-model="newAssignUserForm.name"
                      >{{ newAssignUserForm.name }}</v-text-field
                    >
                    <v-card-title
                      class="d-flex justify-left"
                      style="width: 100%;"
                      ><span class="mr-2" style="">SOWerk Type:</span
                      ><span
                        style="color: #7C7C7C; white-space: pre-wrap; word-break: break-word;"
                        >(Select A Type That Describes What This Application
                        Provides)</span
                      ></v-card-title
                    >
                    <v-select
                    ...
                    <v-card-title
                      class="d-flex justify-left"
                      style="width: 100%;"
                      ><span class="mr-2" style="">SOWerk Category:</span
                      ><span
                        style="color: #7C7C7C; white-space: pre-wrap; word-break: break-word;"
                        >(Select A Category That Describes What This Application
                        Provides)</span
                      ></v-card-title
                    >
                    <v-autocomplete
                    ...
                    <v-card-title
                      class="d-flex justify-left"
                      style="width: 100%;"
                      ><span class="mr-2" style="">SOWerk Tags:</span
                      ><span style="color: #7C7C7C"
                        >(Choose your tags here)</span
                      ></v-card-title
                    >
                    <v-combobox
                      style="width: 95%;"
                    ...
                    >
                      <template v-slot:selection="data">
                        ...
                        >
                          ...
                          <v-card-text v-else>{{ data.item }}</v-card-text>
                          <v-btn
                            @click="removeTagCompanyTemplate(data.item)"
                            text
                            class="ml-n6"
                            >X</v-btn
                          >
                  ...
                  <v-row
                    style="width: 98%; border-bottom: 1px dashed #A61C00; border-top: 1px dashed #A61C00"
                    class="d-flex flex-column align-center my-4"
                  >
                    <v-row
                      style="width: 100%; border: 1px solid #151515; box-shadow: 4px 4px 4px #7C7C7C; border-radius: 5px;"
                      class="d-flex flex-column align-center my-4"
                    >
                      <v-card-title style="color: #A61C00;"
                        >SOWerk Standard Questions</v-card-title
                      >
                      <v-card-subtitle
                        >Add your custom questions below</v-card-subtitle
                      >
                      <div
                      ...
                      >
                        <p
                          v-for="(form, index) in defaultFormFields"
                  ...
                  >
                    <v-card-title
                      ...
                      style="color: #A61C00;"
                      >Custom Application Questions</v-card-title
                    >
                    <v-card-subtitle
                      class="d-flex justify-center"
                      style="width: 80%;"
                      >Use the following area to add, edit, or rearrange your
                      approved vendor questions. Drag and drop questions from
                      the library to the right or add completely new questions.
                    </v-card-subtitle>
                    <draggable
                    ...
                    >
                      <v-card
                        style="width: 100%; border:2px outset lightgrey;"
                        class="my-4 d-flex flex-column align-center"
                        v-for="(form, index) in newAssignUserForm.formfields"
                      >
                        <v-card-title
                          class="d-flex justify-start align-center flex-wrap"
                          style="width: 100% !important; font-size: 16px; word-break: break-word; white-space: pre-wrap; "
                        >
                          <v-icon style="color: #707070; width: 10%;"
                            >mdi-cursor-move</v-icon
                          >
                          <p
                            class="mx-2 pt-10"
                            style="width: 70%; text-align: center; word-break: break-word; white-space: pre-wrap;"
                          >
                            {{ Number(index) + 1 }} - {{ form.name }}
                          </p>
                          <v-btn
                            class="mr-2"
                            style="color: #A61c00; width: 10%;"
                            text
                            @click="openEditFormField(form, index)"
                          ...
                          <div class="d-flex justify-end" style="width: 100%;">
                            <v-btn
                              class="mr-4"
                              style="color: #A61c00; text-align: right; font-size: 30px;"
                              text
                        ...
                        >
                          <v-btn
                            ...
                            @click.prevent="addOption(form, index)"
                          ...
                          <template>
                            <v-card-title
                              v-for="(option, iVal) in form.options.split(', ')"
                              style="width: 100%; white-space: pre-wrap !important;"
                              class="d-flex justify-center"
                            >
                              <v-text-field
                                style="width: 80%;"
                                ...
                                v-model="form.options.split(', ')[iVal]"
                                >{{ option }}</v-text-field
                              >
                              <v-btn
                                class="px-6 ml-12"
                                style="width: 10%; background: #A61C00; color: white;"
                                @click.prevent="
                                  removeOption(option, iVal, form, index)
                                "
                                text
                                >X</v-btn
                              >
                ...
                <rawDisplayer
                  :value="newAssignUserForm.formfields"
                  title="List 1"
                />
              </v-col>
              ...
              <v-col
                cols="6"
                class="d-flex flex-column align-center"
                style="border-left: 1px dashed #A61C00;"
              >
                <v-card-title style="color: #A61C00; text-align: center"
                  >New Questions</v-card-title
                >
                <v-card-subtitle style="text-align: center"
                  >Need to add a new/different question? You can drag and drop a
                  new question field over to your application column, then
                  customize it.</v-card-subtitle
                >
                              <!-- <draggable
                                style="width: 100%;"
                                class="dragArea list-group"
                              ...
                              > -->
                  <v-card
                    style="border:2px outset lightgrey; width: 100%;"
                    class="my-2 d-flex flex-column align-center"
                    v-for="(form, index) in formTypes"
                  >
                    <v-card-title
                      style="font-size: 16px; width: 100% !important;"
                    ...
                    >
                      ...
                      <v-btn style="color: #A61c00; width: 10%;" text
                        ><v-icon style="width: 100%;">mdi-cog</v-icon></v-btn
                      >
                    ...
                    >
                      <v-btn
                        style="background: #707070; color: white;"
                        @click.prevent="addOptionInput(form, index)"
                        >Add Another Option</v-btn
                      >
                      <v-card-text
                        v-for="(option, iVal) in formTypes[1].options"
                        style="width: 100%;"
                        class="d-flex justify-center"
                        ><v-text-field
                          style="width: 80%;"
                          @click.prevent=""
                          label="Selection Name"
                          v-model="formTypes[1].options[iVal]"
                          clearable
                          >{{ option }}</v-text-field
                        >
                        <v-btn
                          ...
                          style="width: 10%; background: #A61C00; color: white;"
                          @click.prevent="
                            removeOptionSelect(option, iVal, form, index)
                          "
                          text
                          >X</v-btn
                        ></v-card-text
                ...
                <section
                  class="d-flex flex-column align-center"
                  style="border-top: 1px dashed #A61C00;"
                >
                  <v-card-title style="color: #A61C00; text-align: center"
                    >Question Library</v-card-title
                  >
                  <v-card-subtitle style="text-align: center"
                    >In this column you can quickly find questions from any
                    existing template in your library. Drag and drop ones you
                    like to your application column, then customize
                    it.</v-card-subtitle
                  >
                  <v-col cols="12" class="d-flex flex-column align-center">
                    <v-row class="mb-n8" v-if="$vuetify.breakpoint.xl">
                      <v-btn
                        @click="sowerkDragNDrop && (companyDragNDrop = false)"
                        color="primary"
                        rounded
                        class="mx-2"
                        style="z-index: 1"
                        >Sowerk Application Templates
                        <v-icon>mdi-arrow-down</v-icon></v-btn
                      >
                      <v-btn
                        @click="companyDragNDrop && (sowerkDragNDrop = false)"
                        color="primary"
                        rounded
                        class="mx-2"
                        style="z-index: 1"
                    ...
                    <v-row
                      style="width: 100%;"
                      class="mb-n8 d-flex flex-column align-center"
                      v-else
                    >
                      <v-btn
                        @click="
                      ...
                      <v-btn
                        @click="
                          ;(companyDragNDrop = true) &&
                            (sowerkDragNDrop = false)
                        "
                        color="primary"
                        rounded
                        style="width: 90%; z-index: 1"
                  ...
                  <transition name="slide-fade">
                    ...
                    >
                            ...
                            <template v-slot:default>
                              ...
                              <tbody style="width: 95%;">
                                ...
                                >
                                  ...
                                  >
                                    <v-card
                                      style="width: 95%; border:2px outset lightgrey;"
                                      class="d-flex justify-start"
                                    >
                                      <v-card-text
                                        style="width: 30%;"
                                        class="d-flex flex-column align-center"
                                        ><v-icon style="color: #707070;"
                                          >mdi-cursor-move</v-icon
                                        >Question# {{ index + 1 }}</v-card-text
                                      >
                      ...
                      <template v-slot:item.questions="{ item }">
                        <p v-if="item.applicationtemplatesformfields">
                          {{ item.applicationtemplatesformfields.length }}
                        </p>
                      </template>
                    </v-data-table>
                  </transition>
                  <transition name="slide-fade">
                    ...
                    >
                            ...
                            <template v-slot:default>
                              ...
                              <tbody style="width: 95%;">
                                ...
                                >
                                  <tr
                                    v-for="(app,
                                    index) in item.companytemplatesformfields"
                                    :key="app.name"
                                    style="width: 100%;"
                                    class="d-flex justify-center"
                                  >
                      ...
                      <template v-slot:item.questions="{ item }">
                        <p v-if="item.companytemplatesformfields">
                          {{ item.companytemplatesformfields.length }}
                        </p>
                      </template>
                    </v-data-table>
                  </transition>
            ...
            <v-card
              v-if="openEditFormFieldLoad"
              class="d-flex flex-column align-center justify-center"
              style="width: 70vw; height: 50vh; position: fixed; left: 25vw; top: 25vh; z-index: 1000;"
            >
              <v-card-text
                >Edit Question #{{ openEditFormFieldVal.order }} For Form -
                {{ openEditFormFieldVal.name }}</v-card-text
              >
              <v-form
                style="width: 90%;"
                class="d-flex flex-wrap justify-center"
              >
                <v-text-field
                  v-model="openEditFormFieldVal.name"
                  class="mx-2"
                  style="width: 45%;"
                  :label="'Question'"
                  :name="openEditFormFieldVal.name"
                ></v-text-field>
                <v-checkbox
                  v-model="openEditFormFieldVal.required"
                  class="mx-2"
                  style="width: 45%;"
                  :label="'Required Question?'"
                  :name="openEditFormFieldVal.required"
                ></v-checkbox>
                <v-select
                  item-text="name"
                  item-value="value"
                  :items="typeSelect"
                  v-model="openEditFormFieldVal.type"
                  class="mx-2"
                  style="width: 45%;"
                  :label="'Type of Question'"
                  :name="openEditFormFieldVal.type"
                ></v-select>
              </v-form>
              <div style="width: 100%;" class="d-flex justify-space-between">
                <v-btn
                  @click="deleteSingleFormfield(openEditFormFieldVal)"
                  class="ml-2 mb-2"
                  color="primary"
                  outlined
                  >Delete Form Field</v-btn
                >
                <v-btn
                  @click="updateSingleFormfield(openEditFormFieldVal)"
                  class="mr-2 mb-2"
                  color="white"
                  style="background: #707070;"
                  outlined
                  >Update Form Field</v-btn
                >
              </div>
              <v-btn
                text
                style="font-size: 30px; position: absolute; right: 10px; top: 10px;"
                @click="closeEditFormField"
                >X</v-btn
              >
            </v-card>
    ...
    >
      <transition name="slide-fade">
        <v-card
          class="mt-12 d-flex flex-column"
          v-if="addNewVendorFormLoad && !step5"
          style="width: 38%;"
        >
          <v-card-title
            v-if="
            ...
            class="mb-10"
            style="color: white; background-color: #a61c00; width: 50%; text-align: center; position: absolute; left: 10px; top: -20px; border-radius-top-left: 20px; border-radius-top-right: 20px;"
            >Add New Vendor Form</v-card-title
          >
          <v-card-title
            v-else
            class="mb-10"
            style="color: white; background-color: #a61c00; width: 100%; text-align: center; position: absolute; left: 0px; top: -20px; border-radius-top-left: 20px; border-radius-top-right: 20px;"
            >Add New Vendor Form</v-card-title
          >
          <!--        // STEP BUTTONS-->
          <!--        <transition name="slide-fade">-->
          ...
          <transition name="slide-fade">
            <v-card-title
              ...
              >Step 1 - Application Name</v-card-title
            >
          </transition>
          <transition name="slide-fade">
            <p v-if="step1" class="ml-4" style="width: 80%; font-size: 18px;">
              How you name each Vendor application is important. You should
              understand that the Vendor community will also see this name when
              applying. Additionally, a good application name can help you and
              your company stay organized.
            </p>
          </transition>
          <transition name="slide-fade">
            <v-card-title
              ...
              class="mt-10"
              style="text-align: center; width: 100%;"
              >Step 2 - Select Channel</v-card-title
            >
            <v-card-title
              v-else-if="
                step2 && !$vuetify.breakpoint.lg && !$vuetify.breakpoint.xl
              "
              class="mt-10"
          ...
          <transition name="slide-fade">
            <p v-if="step2" class="ml-4" style="width: 80%; font-size: 18px;">
              Every Vendor application is specifically tied to a Channel in your
              account. Besides keeping your account organized this also provides
              you the flexibility to create custom Vendor requirements for each
              channel (i.e. Facility Location, Department, etc.).<br />
              <span style="color: #A61C00"
                >* <span style="text-decoration: underline;">Stop</span></span
              >: If you are planning to use the same Vendor vetting questions
              across multiple channels (locations, departments, major projects)
              you may want to start with building a Company Template. A company
              template can be created once and then assigned to multiple
              channels. This saves you time. What’s even better is that after
              you assign a template to channels you can always go back to any
              one specific channel and edit that application without affecting
              the original company template or other channels. Tip #2, a quick
              way to start a company template is to first go to SOWerk
              Templates, pick one that is most relevant or has most of your
              desired questions already, add to your company templates and then
              start editing that new company template.
            </p>
          </transition>
          <transition name="slide-fade">
            <v-card-title
              ...
              >Step 3 - Choose A Vendor Type</v-card-title
            >
          </transition>
          <transition name="slide-fade">
            <p v-if="step3" class="ml-4" style="width: 80%; font-size: 18px;">
              Which type of Vendor are you looking for? SOWerk requires you to
              specifically choose a type so to aid in organizing your Vendor
              Applications and to improve how Vendors can find and apply for
              approval.
            </p>
          </transition>
          <transition name="slide-fade">
            <v-card-title
              ...
              class="mt-10"
              style="text-align: center; width: 80%;"
              >Step 4 - Select A SOWerk Category</v-card-title
            >
          </transition>
          <transition name="slide-fade">
            <p v-if="step4" class="ml-4" style="width: 80%; font-size: 18px;">
              Every SOWerk approved Vendor Application must be assigned to only
              ONE category. SOWerk categories are based off the same NAICS
              options as the United States government uses to classify business
              activities. Choose the category that best suits your needs. You
              can use Tags in the following steps to add additional details.
            </p>
          </transition>
        </v-card>
      </transition>
      ...
      <transition name="slide-fade">
        ...
        >
          ...
          <transition name="slide-fade">
            <v-form
              class="py-16 mt-16 d-flex flex-column align-end"
              style="width: 80%; margin: 0 auto;"
              v-if="addNewVendorFormLoad && step1"
            >
              <v-text-field
              ...
              >
                <template v-slot:label>
                  <p
                    class="grey--text text--darken-4 font-weight-bold mb-16"
          ...
          <transition name="slide-fade">
            ...
            >
              <v-text-field
                ...
                outlined
                style="width: 90%;"
                label="Search By Channel Name, Email, or Phone"
                v-model="searchChannel"
                light
              ></v-text-field>
            </v-row>
          ...
          <transition name="slide-fade">
            ...
            >
              ...
              <template v-slot:item.actions="{ item }">
                <v-btn
                  @click="getServiceForVendor(item)"
                  class="my-1"
                  color="#707070"
                  style="color: white; width: 100%;"
                  >Assign Channel</v-btn
          ...
          <transition name="slide-fade">
            <div
              class="d-flex justify-space-between"
              v-if="addNewVendorFormLoad && step4"
            >
              <v-btn
                @click="backVendorFormStep4"
                color="primary"
                style="width: 30%;"
                class="my-2 py-7"
                >< Back</v-btn
          ...
          <transition name="slide-fade">
            <v-btn
              ...
              color="primary"
              class="px-16 py-8"
              style="z-index: 1; position:absolute; top: 10px; right: 10px;"
              >+ Add Category</v-btn
            >
          </transition>
          <transition name="slide-fade">
            ...
            >
              <thead>
                ...
                >
                  <th style="color: #a61c00; width: 70%; text-align: center">
                    Category
                  </th>
              ...
              <tbody>
                <tr
                  v-for="(service, indexService) in locationVal.services"
                  style="background: none !important;"
                  class="d-flex"
                >
                  <td
                    style="width: 70%; text-align: center; height: auto;"
                    class="py-1"
                  >
                    {{ service.name }}
                  </td>
                  <td
                    style="width: 30%; margin: 0 auto; height: auto;"
                    class="d-flex flex-column align-center"
                  >
                    <v-btn
                      @click="assignToServiceVendor(service)"
                      class="my-1"
                      color="#707070"
                      style="color: white; width: 100%;"
                      >Assign Category</v-btn
                    >
                    <v-btn
                      @click="deleteService(service, indexService)"
                      class="my-1"
                      color="#707070"
                      style="color: white; width: 100%;"
        ...
        >
          <transition name="slide-fade">
            <v-card-title
              ...
              class="mt-10"
              style="text-align: center; width: 80%;"
              >Step 5 - Drag and Drop questions and edit them to your liking,
              then hit submit!</v-card-title
            >
          </transition>
          <transition name="slide-fade">
            <v-container
            ...
            >
              <v-row class="d-flex justify-center" style="width: 100%;">
                ...
                >
                  ...
                  <v-btn
                    :href="
                      'https://www.sowerk.com/dashboard/vendors/applications'
                    "
                    style="width: 45%;"
                    color="#707070"
                    rounded
                ...
                <v-row class="d-flex justify-center" style="width: 100%;">
                    ...
                    >
                      ...
                      >
                        ...
                        <v-text-field
                          ...
                          label="Enter Form Name Here"
                          v-model="assignUserform.name"
                          >{{ assignUserform.name }}</v-text-field
                        >
                        <v-card-title
                          class="d-flex justify-left"
                          style="width: 100%;"
                          ><span class="mr-2" style="">Account Channel:</span
                          ><span
                            style="color: #7C7C7C; white-space: pre-wrap; word-break: break-word;"
                            >(Select the Channel that you want to assign this
                            application to)</span
                          ></v-card-title
                        >
                        <v-select
                        ...
                        >
                          <template slot="selection" slot-scope="data">
                            <v-card-text style="" v-if="data.item.name">{{
                              data.item.name
                            }}</v-card-text>
                          </template>
                          <template slot="item" slot-scope="data">
                        ...
                        <v-card-title
                          ...
                          ><span
                            style="color: #7C7C7C; white-space: pre-wrap; word-break: break-word;"
                            >(Select A Category That Describes What This
                            Application Provides)</span
                          ></v-card-title
                        >
                        <v-autocomplete
                          label=""
                      ...
                      >
                        ...
                        <v-card-subtitle
                          class="d-flex justify-center"
                          style="width: 80%;"
                          >Use the following area to add, edit, or rearrange
                          your approved vendor questions. Drag and drop
                          questions from the library to the right or add
                        ...
                        >
                          <v-card
                            style="width: 100%; border:2px outset lightgrey; word-break: break-word; white-space: pre-wrap;"
                            class="my-4 d-flex flex-column align-center"
                            v-for="(form,
                            index) in newAssignUserForm.formfields"
                          >
                            <v-card-title
                              class="d-flex justify-start align-center flex-wrap"
                              style="width: 100% !important; font-size: 16px; "
                  ...
                  >
                    ...
                    >
                    <v-card-subtitle style="text-align: center"
                      >Need to add a new/different question? You can drag and
                      drop a new question field over to your application column,
                      then customize it.</v-card-subtitle
                    >
                    <draggable
                      style="width: 100%;"
                      class="dragArea list-group"
                    ...
                    >
                      ...
                      <v-card-subtitle style="text-align: center"
                        >In this column you can quickly find questions from any
                        existing template in your library. Drag and drop ones
                        you like to your application column, then customize
                        it.</v-card-subtitle
                      >
                      <v-col cols="12" class="d-flex flex-column align-center">
                        <v-row class="mb-n8" v-if="$vuetify.breakpoint.xl">
                          <v-btn
                            @click="
                              sowerkDragNDrop && (companyDragNDrop = false)
                            "
                            color="primary"
                            rounded
                            class="mx-2"
                          ...
                          <v-btn
                            @click="
                              companyDragNDrop && (sowerkDragNDrop = false)
                            "
                            color="primary"
                            rounded
                            class="mx-2"
                                ...
                                <template v-slot:default>
                                  ...
                                  <tbody style="width: 95%;">
                                    <draggable
                                      ...
                                      class="dragArea list-group"
                                      :list="
                                        item.applicationtemplatesformfields
                                      "
                                      :group="{
                                        name: 'formName',
                                        pull: 'clone',
    ...
    <transition name="slide-fade">
      <v-card
        class="d-flex flex-column align-center justify-center"
        style="z-index:10; position:fixed; top: 15vh; left: 22vw; width: 75vw; height: 60vh; box-shadow: 8px 8px 8px #707070; border: 1px solid #707070;"
        overflow-y-auto
        v-if="addServiceLoad && step4"
      >
        <v-card-title class="mb-6 mt-2" style="color: #a61c00; font-size: 40px;"
          >Select A Category</v-card-title
        >
        <v-row style="width: 100%;">
          <v-col cols="4">
            <v-card-title style="text-decoration: underline"
              >Select A SOWerk Category</v-card-title
            >
            <v-card-text
              >SOWerk categories are based off the same NAICS options as the
              United States government uses to classify business activities.
              Choose the category that best suits your needs. You can use Tags
              in the following steps to add additional details.</v-card-text
            >
          </v-col>
        ...
        <v-btn
          @click="closeService"
          text
          style="position: absolute; top: 10px; right: 10px; font-size: 25px;"
          >X</v-btn
        >
      </v-card>
    </transition>
...
export default {
  ...
  methods: {
    ...
    async getDataForApprovedVendorTable(id) {
      await this.$http
        .get(
          'https://www.sowerkbackend.com/api/companies/ChannelForms/byCompanyId/' +
            id
        )
        .then((response) => {
          console.log(
          ...
          console.log(
            this.listOfUserChannels,
            'YOUR VENDOR APPLICATIONS TABLE DATA SET'
          )
          this.addLocations = response.data.location
          console.log(
            this.addLocations,
            'ADD LOCATION DATA SET, LIST OF CHANNELS'
          )
          this.loading = true
        })
    ...
    async sendToVendorDocs() {
      if (this.channelsList.length <= 0) {
        ...
        await this.$http
          .post(
            'https://www.sowerkbackend.com/api/vendordocuments/byCompaniesId/' +
    ...
    async getChannelsForVendor(vendor) {
      ...
      await this.$http
        .get(
          'https://www.sowerkbackend.com/api/locations/byCompaniesId/' +
            vendor.id
        )
        .then((response) => {
    ...
    async getVendorsList() {
      await this.$http
        .get(
          'https://www.sowerkbackend.com/api/applications/byPmId/' +
            this.currentUser.companies_id
        )
        .then((response) => {
          ...
          this.vendorsList = [
            ...new Map(
              this.vendorsList.map((item) => [item['spcompanies_id'], item])
            ).values()
          ]
          ...
          if (this.vendorsList.length > 0) {
              ...
              this.$http
                .get(
                  'https://www.sowerkbackend.com/api/companies/' +
                    this.vendorsList[i].spcompanies_id
                )
                .then((response) => {
            ...
            console.log(
              'NO ELSE THIS IS THE ONE L;AKSDfjFL;KAJDF;LKASDJF;LASDKFJASDLFKJSDL;FKJSDL'
            )
          }
        })
        .catch((err) => {
    ...
    async getSowerkTags() {
      await this.$http
        .get('https://www.sowerkbackend.com/api/sowerktags')
        .then((response) => {
    ...
    async removeTag(item) {
      ...
      this.applicationtemplateTagsNew = this.applicationtemplateTagsNew.filter(
        (locationTag) => {
          if (
            typeof locationTag === 'object' &&
            locationTag.name !== item.name
          ) {
            return locationTag
    ...
    async removeTagCompanyTemplate(item) {
      ...
      this.newAssignUserFormTagsNew = this.newAssignUserFormTagsNew.filter(
        (locationTag) => {
          if (
            typeof locationTag === 'object' &&
            locationTag.name !== item.name
    ...
    async getNaicsList() {
      await this.$http
        .get('https://www.sowerkbackend.com/api/naicslist/')
        .then((response) => {
    ...
    async getFormFields(id) {
      await this.$http
        .get('https://www.sowerkbackend.com/api/formfields/byUserFormId/' + id)
        .then(async (response) => {
          ...
          this.applicationTemplateVal[this.valueFormFields].formfields =
            response.data
    ...
    async getApplicationTemplates() {
      ...
      await this.$http
        .get('https://www.sowerkbackend.com/api/applicationtemplates')
        .then(async (response) => {
          ...
          console.log(
            this.applicationTemplates,
            'application templates this.applicationtemplates'
          )
        })
        .catch((err) => {
    ...
    async getApplicationTemplatesFormFields(id, indexPostion) {
      await this.$http
        .get(
          'https://www.sowerkbackend.com/api/applicationtemplatesformfields/byApplicationTemplatesId/' +
            id
        )
        .then((response) => {
          console.log(
            response.data,
            'formfields for application template userform',
            id
          )
          ...
          this.applicationTemplates[
            indexPostion
          ].applicationtemplatesformfields = response.data
        })
        .catch((err) => {
    ...
    async getCompanyTemplates() {
      ...
      await this.$http
        .get(
          'https://www.sowerkbackend.com/api/companytemplates/byCompanyId/' +
            this.currentUser.companies_id
        )
        .then(async (response) => {
          ...
          console.log(
            this.companyTemplates,
            'application templates for company'
          )
        })
        .catch((err) => {
    ...
    async getCompanyTemplatesFormFields(id, indexPostion) {
      await this.$http
        .get(
          'https://www.sowerkbackend.com/api/companytemplatesformfields/byCompanyTemplatesId/' +
            id
        )
        .then((response) => {
          ...
          this.companyTemplates[indexPostion].companytemplatesformfields =
            response.data
        })
        .catch((err) => {
          console.log(err, 'err in application templates form fields')
      ...
      await this.$http
        ...
        .then(async (response) => {
          ...
          if (template.applicationtemplatesformfields.length > 0) {
            for (
              let i = 0;
              i < template.applicationtemplatesformfields.length;
              i++
            ) {
              let formfield = {
              ...
              await this.$http
                .post(
                  'https://www.sowerkbackend.com/api/companytemplatesformfields/byCompanyTemplatesId/' +
                    response.data.companytemplate.id,
                  formfield
                )
                .then((response) => {
                  console.log(
                    'success in posting formfields to company templates userform',
                    response.data.formfield
                  )
                })
                .catch((err) => {
                  console.log(
                    err,
                    'err in posting formfields to company templates userform'
                  )
                })
            }
          }
    ...
    async deleteCompanyTemplates(template) {
      ...
      await this.$http
        .get(
          'https://www.sowerkbackend.com/api/companytemplatetags/byCompanyTemplateId/' +
            template.id
        )
        .then((response) => {
          if (response.data.length > 0) {
            for (let i = 0; i < response.data.length; i++) {
              this.$http
                .delete(
                  'https://www.sowerkbackend.com/api/companytemplatetags/' +
                    response.data[i].id
                )
                .then(async (response) => {
      ...
      for (let i = 0; i < template.companytemplatesformfields.length; i++) {
        await this.$http
          .delete(
            'https://www.sowerkbackend.com/api/companytemplatesformfields/' +
              template.companytemplatesformfields[i].id
          )
          .then(async (response) => {
            console.log('success in deleting formfield company template')
          })
      ...
      await this.$http
        .delete(
          'https://www.sowerkbackend.com/api/companytemplates/' + template.id
        )
        .then(async (response) => {
    ...
    async deleteUserForm(userform) {
      ...
      if (confirm('Are you sure you want to delete this?')) {
        try {
          await this.$http
            .get(
              'https://www.sowerkbackend.com/api/userformtags/byUserformId/' +
                userform.id
            )
            .then((response) => {
              if (response.data.length > 0) {
                for (let i = 0; i < response.data.length; i++) {
                  this.$http
                    .delete(
                      'https://www.sowerkbackend.com/api/userformtags/' +
                        response.data[i].id
                    )
                    .then(async (response) => {
          ...
          await this.$http
            .get(
              'https://www.sowerkbackend.com/api/formfields/byUserFormId/' +
                userform.id
            )
            .then((response) => {
              if (response.data.length > 0) {
                for (let i = 0; i < response.data.length; i++) {
                  this.$http
                    .delete(
                      'https://www.sowerkbackend.com/api/formfields/' +
                        response.data[i].id
                    )
                    .then(async (response) => {
          ...
          await this.$http
            .delete(
              'https://www.sowerkbackend.com/api/userforms/' + userform.id
            )
            .then((response) => {
    ...
    async submitTagCategoryType(item) {
      ...
      await this.$http
        .post(
          'https://www.sowerkbackend.com/api/userforms/byLocationId/' +
            this.locationIdChoice,
          userform
        )
        .then(async (response) => {
          ...
          if (this.applicationtemplateTagsNew.length > 0) {
            for (let i = 0; i < this.applicationtemplateTagsNew.length; i++) {
              await this.$http
                .post(
                  'https://www.sowerkbackend.com/api/userformtags/byUserformId/' +
                    response.data.userform.id,
                  this.applicationtemplateTagsNew[i]
                )
                .then((response) => {
          ...
          if (this.addLocation.applicationtemplatesformfields) {
            for (
              let i = 0;
              i < this.addLocation.applicationtemplatesformfields.length;
              i++
            ) {
              let formfield = {
                ...
                required: this.addLocation.applicationtemplatesformfields[i]
                  .required,
                options: this.addLocation.applicationtemplatesformfields[i]
                  .options,
              ...
              await this.$http
                ...
                .then((res) => {
                  console.log(
                    res,
                    'successful in posting formfields to userform'
                  )
                })
                .catch((err) => {
          ...
          if (this.addLocation.companytemplatesformfields) {
            for (
              let i = 0;
              i < this.addLocation.companytemplatesformfields.length;
              i++
            ) {
              let formfield = {
                userform_id: response.data.userform.id,
                ...
                required: this.addLocation.companytemplatesformfields[i]
                  .required,
    ...
    async getUserformsVal(id) {
      console.log(id, 'id')
      await this.$http
        .get('https://www.sowerkbackend.com/api/userforms/' + id)
        .then((response) => {
          console.log(response, 'userforms')
          this.newAssignUserForm = { ...response.data }
          this.step3finishedFormFields = true
          this.newAssignUserForm.formfields = this.newAssignUserForm.formfields.sort(
            (a, b) => {
          ...
          if (
            this.newAssignUserForm.formfields[0] === 'There are no formfields'
          ) {
    ...
    async saveUserForm() {
        ...
        for (let i = 0; i < this.newAssignUserFormTagsNew.length; i++) {
          this.$http
            ...
            .then((responseVal) => {
              console.log(
                responseVal,
                'success in posting company template tags'
              )
            })
            .catch((err) => {
      ...
      this.newAssignUserForm.formfields.forEach(async (formfield, index) => {
        ...
        if (this.originalUserForms.some((val) => val.id === 0)) {
          ...
          await this.$http
            .put(
              'https://www.sowerkbackend.com/api/formfields/' + formfield.id,
              changes
            )
            .then((response) => {
      ...
      await this.$http
        .put(
          'https://www.sowerkbackend.com/api/userforms/' +
            this.newAssignUserForm.id,
          userformEdit
        )
        .then((response) => {
    ...
    async saveCompanyTemplate() {
      ...
      await this.newAssignUserForm.formfields.forEach(
        async (formfield, index) => {
      ...
      await this.$http
        .put(
          'https://www.sowerkbackend.com/api/companytemplates/' +
            this.newAssignUserForm.id,
          userformEdit
        )
        .then((response) => {
    ...
    async reorderFormField({ moved }) {
      ...
      console.log(
        this.newAssignUserForm.formfields,
        'updating userForms.formfields'
      )
    },
    ...
    async deleteSingleFormfield(formfieldVal) {
      ...
      if (formfieldVal.id === 0) {
        ...
        let confirmDelete = confirm(
          'We noticed this question is saved to your application. Are you sure you would like to remove this question from your application'
        )
        if (confirmDelete === true) {
          ...
          this.$http
            .delete(
              'https://www.sowerkbackend.com/api/formfields/' + formfieldVal.id
            )
            .then((response) => {
    ...
    async getCompanyDocuments() {
      ...
      await this.$http
        .get(
          'https://www.sowerkbackend.com/api/companydocuments/byCompaniesId/' +
            this.currentUser.companies_id
        )
        .then((response) => {
          ...
          for (let i = 0; i < response.data.length; i++) {
            if (
              response.data[i].vendor_channelsId === null &&
              response.data[i].vendor_companiesId === null
            ) {
    ...
    async deleteCompanyDocument(document, index) {
      await this.$http
        .delete(
          'https://www.sowerkbackend.com/api/companydocuments/' + document.id
        )
        .then((response) => {
    ...
    async selectCompanyDocumentsImage(e) {
      ...
      this.companyDocumentImageUrl = URL.createObjectURL(
        this.companyDocument.documentUrl
      )
    ...
    async deleteService(service, position) {
      console.log(
        this.locationVal.services,
        'SERVICES FOR DELETING PURPOSE',
        position
      )
      this.locationVal.services.splice(this.locationVal.services[position], 1)
      await this.$http
        .delete('https://www.sowerkbackend.com/api/services/' + service.id)
        .then((response) => {
    ...
    async removeOption(option, iVal, form, index) {
      console.log(
        ...
        'index of option',
        form,
        'remove option to this form',
        index,
        'index of form'
      )
      console.log(
        this.newAssignUserForm.formfields[index],
        'formfields specific one'
      )
      console.log(this.newAssignUserForm.formfields, 'formfields all')
      this.newAssignUserForm.formfields[
        index
      ].options = this.newAssignUserForm.formfields[index].options.filter(
        (optionVal) => optionVal !== option
      )
    },
    async removeOptionSelect(option, iVal, form, index) {
      this.formTypes[1].options = this.formTypes[1].options.filter(
        (optionVal) => optionVal !== option
      )
    },
    async reorderFormFieldAdd() {
      for (let i = 0; i < this.newAssignUserForm.formfields.length; i++) {
        ...
        this.newAssignUserForm.formfields[i].order = i
        console.log(
          this.newAssignUserForm.formfields[i].options,
          'OPTIONS!!!!!'
        )
      }
      console.log(
    ...
    async addForm(form) {
      ...
      if(Array.isArray(form.options)){
        this.itemoptions = form.options.join(', ')
        console.log(this.itemoptions, form.options.join(', '), "NEW CONSOLE LOG 12312312312313123")
      } else {
