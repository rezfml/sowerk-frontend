<template>
  <v-container overflow-y-auto>
    ...
    <transition name="slide-fade">
      <v-divider
        v-if="loading"
        style="width: 100%; border: 1px solid #707070"
      ></v-divider>
    </transition>
        ...
        <v-col style="width: 55%;">
          <v-card class="d-flex flex-column align-center" style="width: 100%;">
            ...
            <v-card-subtitle style="text-align: center"
              >This column represents your questions being asked of a Vendor.
              You can reorder and edit any question.
            </v-card-subtitle>

            <v-row style="width: 98%; border-bottom: 1px dashed #A61C00">
              <v-card-title class="d-flex justify-center" style="width: 100%;"
                ><span class="mr-2" style="color:#a61c00;"
                  >Application Name:</span
                ></v-card-title
              >
              <v-text-field
                label="A Good Name Helps You & Vendors - i.e. Commercial Cleaning - Dexter IA"
                style="width: 70%;"
                v-model="companyTemplate.form_name"
                clearable
              ></v-text-field>
              <v-card-title class="d-flex justify-center" style="width: 100%;"
                ><span class="mr-2" style="color:#a61c00;"
            ...
            <v-row
              style="width: 98%; border-bottom: 1px dashed #A61C00"
              class="d-flex flex-column align-center"
            >
              <v-card-title style="color: #A61C00;"
                >Standard Questions, Add Custom Questions Below</v-card-title
              >
              <div
              ...
              >
                ...
                >
                  <span style="color: #A61C00;">#{{ Number(index) + 1 }}</span>
                  - {{ form.name }}
                </p>
              </div>
            </v-row>
            <v-row style="width: 98%;" class="d-flex flex-column align-center">
              ...
              >
              <v-card-subtitle class="d-flex justify-center" style="width: 80%;"
                >Use the following area to add, edit, or rearrange your approved
                vendor questions. Drag and drop questions from the library to
                the right or add completely new questions.
              </v-card-subtitle>
              <draggable
              ...
              >
                <v-card
                  style="border:2px outset lightgrey; width: 100% !important;"
                  class="my-4 d-flex flex-column align-center"
                  v-for="(form,
                  index) in companyTemplate.companytemplatesformfields"
                >
                  <transition name="slide-fade">
                    <v-card-title
                  ...
                  >
                    <v-btn
                      ...
                      @click.stop="addOption(form, index)"
                      >Add Another Option</v-btn
                    >
                    <v-card-title
                      v-if="form.options !== String"
                      v-for="(option, iVal) in form.options"
                      ...
                      ><v-text-field
                        ...
                        v-model="form.options[iVal]"
                        >{{ option }}</v-text-field
                      >
                      <v-btn
                        class="px-6 ml-12"
                        style="width: 10%; background: #A61C00; color: white;"
                        @click.prevent="removeOption(option, iVal, form, index)"
                        text
                        >X</v-btn
                      ></v-card-title
                    >
          ...
          <rawDisplayer
            :value="companyTemplate.companytemplatesformfields"
            title="List 1"
          />
        </v-col>

        <v-col
          style="width: 35%; border-left: 1px dashed #A61C00;"
          class="d-flex flex-column align-center"
        >
          <v-card-title style="color: #A61C00; text-align: center"
          ...
          >
          <v-card-subtitle style="text-align: center"
            >Need to add a new/different question? You can drag and drop a new
            question field over to your application column, then customize
            it.</v-card-subtitle
          >
          <!--          <draggable-->
          <!--            style="width: 100%;"-->
          ...
          <v-card
            ...
            class="my-2 d-flex flex-column align-center list-group-item"
          ...
          >
            ...
            >
              <v-btn
                style="background: #707070; color: white;"
                @click.stop="addOptionInput(form, index)"
                >Add Another Option</v-btn
              >
              <v-card-text
                ...
                <v-btn
                  class="px-6 ml-12"
                  style="width: 10%; background: #A61C00; color: white;"
                  @click.prevent="removeOptionSelect(option, iVal, form, index)"
                  text
                  >X</v-btn
                ></v-card-text
              >
          ...
          <transition name="slide-fade">
            <v-container class="" overflow-y-auto>
              <v-row
                class="d-flex justify-center"
                style="width: 100%; border-top: 1px dashed #A61C00"
              >
                <v-card-title style="color: #A61C00; text-align: center"
                ...
                <v-card-subtitle style="text-align: center"
                  ...
                  existing template in your library. Drag and drop ones you like
                  to your application column, then customize
                  it.</v-card-subtitle
                >
                <v-col cols="12" class="d-flex flex-column align-center">
                  <v-row class="mb-n8" v-if="$vuetify.breakpoint.xl">
                    <v-btn
                      @click="
                        ;(sowerkDragNDrop = true) && (companyDragNDrop = false)
                      "
                      color="primary"
                      rounded
                      class="mx-2"
                    ...
                    <v-btn
                      @click="
                        ;(companyDragNDrop = true) && (sowerkDragNDrop = false)
                      "
                      color="primary"
                      rounded
                      class="mx-2"
                          ...
                          >
                            <template v-slot:default>
                              ...
                              <tbody style="width: 95%;">
                                ...
                                >
                                  <tr
                                    v-for="app in item.applicationtemplatesformfields"
                                    :key="app.name"
                                    style="width: 100%;"
                                    class="d-flex justify-center"
                                  >
                                    ...
                                    >
                                      <v-card-text
                                        ...
                                        ><v-icon style="color: #707070;"
                                          >mdi-cursor-move</v-icon
                                        >Question# {{ app.order }}</v-card-text
                                      >
                          ...
                          >
                            <template v-slot:default>
                              ...
                              <tbody style="width: 95%;">
                                ...
                                >
                                  <tr
                                    v-for="app in item.companytemplatesformfields"
                                    :key="app.name"
                                    style="width: 100%;"
                                    class="d-flex justify-center"
                                  >
    ...
    <v-overlay :absolute="absolute" :value="openEditFormFieldLoad">
      <transition name="slide-fade">
        <v-card
          v-if="openEditFormFieldLoad"
          class="d-flex flex-column align-center justify-center"
          style="background-color: white; border: 1px solid #A61c00; width: 70vw; height: 50vh; position: fixed; left: 25vw; top: 25vh; z-index: 1000;"
        >
          <v-card-text
            style="text-align: center; width: 100%; font-size: 24px; color: #A61c00;"
            >Edit Question #{{ openEditFormFieldVal.order + 1 }} For Form -
            {{ openEditFormFieldVal.name }}</v-card-text
          >
          <v-form
            style="width: 90%; font-size: 24px;"
            class="d-flex flex-wrap justify-center"
          >
            <v-text-field
          ...
          <div style="width: 100%;" class="d-flex justify-center">
            ...
            <v-btn
              ...
              class="mx-4 mb-2"
              color="white"
              style="background: #707070; width: 30%;"
              outlined
          ...
          <v-btn
            text
            style="font-size: 48px; position: absolute; right: 20px; top: 20px;"
            light
...
export default {
  ...
  methods: {
    ...
    async getUserforms(id) {
      ...
      await this.$http
        ...
        .then((response) => {
          ...
          if (
            response.data.companytemplatesformfields.some(
              (question) => question.name === 'Vendor Name'
            )
          ) {
          ...
          this.companyTemplate.companytemplatesformfields = this.companyTemplate.companytemplatesformfields.filter(
            (formfield) => {
              if (
                formfield.name !== 'Vendor Name' &&
                formfield.name !== 'Vendor Type' &&
                formfield.name !== 'Vendor Category' &&
                formfield.name !== "Vendor's Address of Application" &&
                formfield.name !== 'Company Founded' &&
                formfield.name !== 'Number of Employees' &&
                formfield.name !== 'SOWerk Connections' &&
                formfield.name !== 'Contact Person Name' &&
                formfield.name !== 'Contact Person Phone' &&
                formfield.name !== 'Contact Person Email' &&
                formfield.name !== 'Contact Website' &&
                formfield.name !== 'Applicants Service Radius' &&
                formfield.name !==
                  "Company's General Liability Insurance Provider" &&
                formfield.name !== 'List of Certifications' &&
                formfield.name !== 'Published Certificates'
              ) {
                return formfield
              }
            }
          ...
          for (
            let i = 0;
            i < this.companyTemplate.companytemplatesformfields.length;
            i++
          ) {
            this.companyTemplate.companytemplatesformfields[
              i
            ].options = this.companyTemplate.companytemplatesformfields[
              i
            ].options
              .replace('{', '')
              .replace('}', '')
              ...
              .split(',')
            console.log(
              this.companyTemplate.companytemplatesformfields[i].options,
              'option #',
              i
            )
          }
          this.finishedFormFields = true
          this.companyTemplate.companytemplatesformfields = this.companyTemplate.companytemplatesformfields.sort(
            (a, b) => {
    ...
    async getService(id) {
      await this.$http
        .get('https://www.sowerkbackend.com/api/services/' + id)
        .then((response) => {
    ...
    async getLocation(id) {
      await this.$http
        .get('https://www.sowerkbackend.com/api/locations/' + id)
        .then((response) => {
    ...
    async getFormFields(id) {
      await this.$http
        ...
        .then((response) => {
          ...
          console.log(
            'ORIGINAL USER FORMS RESPONSE DATA',
    ...
    async saveUserForm() {
      ...
      if (this.originalLocationTags.length > 0) {
        for (let i = 0; i < this.originalLocationTags.length; i++) {
          if (!this.locationTagsNew.includes(this.originalLocationTags[i])) {
            console.log(
              this.originalLocationTags[i],
              'this.location tags DELETE'
            )
            this.$http
              .delete(
                'https://www.sowerkbackend.com/api/companytemplatetags/' +
                  this.originalLocationTags[i].id
              )
              .then((response) => {
      ...
      if (this.locationTagsNew.length > 0) {
        ...
        for (let i = 0; i < this.locationTagsNew.length; i++) {
          if (
            typeof this.locationTagsNew[i] === 'object' &&
            !this.originalLocationTags.includes(this.locationTagsNew[i])
          ) {
      ...
      if (this.userHasDefaults === false) {
        ...
        this.companyTemplate.companytemplatesformfields.forEach(
          async (formfield, index) => {
            formfield['companytemplates_id'] = this.companyTemplates.id
            formfield.order = index
            if (
              !this.originalUserForms.some((val) => val.id === formfield.id)
            ) {
    ...
    async reorderFormField({ moved }) {
      ...
      for (
        ...
        if (
          this.companyTemplate.companytemplatesformfields[i].options !== '' &&
          typeof this.companyTemplate.companytemplatesformfields[i].options ===
            'string'
        ) {
          this.companyTemplate.companytemplatesformfields[
            i
      ...
      // console.log(
      //   this.companyTemplate.companytemplatesformfields,
      //   'updating companyTemplate.companytemplatesformfields'
      // )
    },
    ...
    async deleteSingleFormfield(formfieldVal) {
      ...
      if (formfieldVal.id === 0) {
        this.companyTemplate.companytemplatesformfields.splice(
          formfieldVal.order,
          1
        )
        console.log(
          'this.companyTemplates on delete',
          this.companyTemplate.companytemplatesformfields
        )
      } else {
      ...
      await this.$http
        ...
        .then(async (response) => {
          ...
          let userForm = {
            ...
            companytemplatesformfields:
              response.data.companytemplate.companytemplateformfields
          }

          if (
            response.data.companytemplate.companytemplateformfields[0] ===
            'There are no companytemplateformfields'
          ) {
            userForm.companytemplatesformfields = []
          } else {
            console.log(
              response.data.companytemplate.companytemplateformfields,
          ...
          // )
          if (
            this.companyTemplate.companytemplatesformfields.some(
              (question) => question.name === 'Vendor Name'
            )
          ) {
            this.userHasDefaults = true
    ...
    async addForm(form) {
      ...
      console.log(
        JSON.stringify(this.companyTemplate.companytemplatesformfields),
        'ONE -----'
      )

      this.companyTemplate.companytemplatesformfields.unshift(newForm)

      console.log(this.companyTemplate.companytemplatesformfields, 'TWO -----')
    ...
    async addOption(form, index) {
      ...
      this.companyTemplate.companytemplatesformfields[index].options.push(
        newOption
      )
    },
    ...
    async removeOption(option, iVal, form, index) {
      ...
      // )
      // console.log(
      //   this.companyTemplate.companytemplatesformfields[index],
      ...
      this.companyTemplate.companytemplatesformfields[
        ...
        index
      ].options.filter((optionVal) => optionVal !== option)
    },
