  ...
  <div overflow-y-auto>
    ...
    <transition name="slide-fade">
      <v-card class="d-flex flex-column align-center justify-center" style="width: 100%; height: auto; margin-top: 10%" v-if="feedbackSuccess === false && loading">
        ...
        <!-- SMALL -->
        <v-card-title v-if="$vuetify.breakpoint.sm" style="width:80%; border-radius:3px; font-size:1.4rem;" class="primary white--text justify-center font-weight-regular red-gradient mb-10 mt-8">Do You Have Feedback, <br> Need Support, Or Have An Idea?</v-card-title>

        <!-- MEDIUM -->
        <v-card-title v-if="$vuetify.breakpoint.md" style="width:90%; border-radius:3px; font-size:1.5rem;" class="primary white--text justify-center font-weight-regular red-gradient mb-10 mt-n8">Do You Have Feedback, Need Support, Or Have An Idea?</v-card-title>

        <!-- LARGE -->
        <v-card-title v-if="$vuetify.breakpoint.lg" style="width:90%; border-radius:3px; font-size:1.6rem; line-height:1.5;" class="primary white--text justify-center font-weight-regular red-gradient mb-10 ">Do You Have Feedback, Need Support, Or Have An Idea?</v-card-title>
