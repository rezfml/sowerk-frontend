  ...
  <div>
    ...
    >
      <v-card
        ...
        class="d-flex flex-column justify-center align-center py-6"
              ...
              <v-row>
                <v-flex sm11 offset-sm-1 text-center text-md-left>
                  <v-btn
                    ...
                    outlined
                    rounded
                    @click="$router.push('/landingpage/service-provider')"
                  >
                  ...
                  <v-btn
                    ...
                    outlined
                    rounded
                    @click="$router.push('/landingpage/property-manager')"
                  >
