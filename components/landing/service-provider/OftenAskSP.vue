<template>
<v-flex class="pt-16 pb-16 skew-top" style="background: #EDEDED url('https://sowerk-images.s3.us-east-2.amazonaws.com/asset1.png') no-repeat; background-position: 1100px 54px;">
      <v-container>
        <v-row>
