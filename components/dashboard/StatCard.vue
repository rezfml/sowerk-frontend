<template>
  ...
  <v-container v-if="!$vuetify.breakpoint.xs && !$vuetify.breakpoint.sm && !$vuetify.breakpoint.md" class="d-flex flex-column align-center" style="white-space: pre-wrap !important; background-color: white;">
