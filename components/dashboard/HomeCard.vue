<template>
  <v-container style="width: 100%;">
    <!-- X-SMALL BREAKPOINT -->
    <v-card class="white pt-0 mt-12 mb-4" style="min-width: 100% !important;" v-if="$vuetify.breakpoint.xs">
        ...
        <v-container class="" >
          ...
          >
            ...
            <template v-slot:item.address="{item}">
              <v-row class="d-flex flex-wrap justify-end" style="margin-right:-15%">
                <v-col>
                  <p class="d-flex  flex-wrap justify-end mb-0" style="font-size:.8rem"> {{item.address}} </p>
                  <p class="d-flex  flex-wrap justify-end" style="font-size:.8rem"> {{item.city}}, {{item.state}} {{item.zipcode}}</p>
                </v-col>
                <v-progress-circular
                  v-if="loading === false"
                  indeterminate
            ...
            <template v-slot:item.name="{ item }" >
              <v-row class="d-flex flex-start flex-wrap" style="font-size:1rem; font-weight:bold;">
                {{item.name}}
              </v-row>
            </template>

            <template v-slot:item.full_name="{ item }" >
              <v-row class="d-flex flex-start flex-wrap" style="font-size:.8rem">
            ...
            <template v-slot:item.phone="{ item }" class="my-12" style="font-size:.8rem">
            ...
            <template v-slot:item.actions="{ item }" v-else >
              <v-row class="d-flex justify-end mx-auto pl-3 pr-3 " style="width: 100%;">
                <nuxt-link :to="slug + item.id" append>
                  <v-btn class="my-12 " cols="12" style="width: 100%; color: white;" color="primary">
                    View
                  </v-btn>
                </nuxt-link>
              </v-row>
    ...
    <!-- SMALL BREAKPOINT -->
    <v-card class="white pt-0 mt-12 mb-4" style="width: 100% !important;" v-else-if="$vuetify.breakpoint.sm">
      <v-container class="pt-0" fluid  >
        <v-card-title
          style="position: absolute; top: -0px; left: 35px; width: 92%; border-radius: 3px; font-size: 14px;"
          class="primary white--text font-weight-regular red-gradient TitleCard"
    ...
    <!-- MEDIUM BREAKPOINT -->
    <v-card class="white pt-0 mt-12 mb-4" style="min-width: 100% !important;" v-else-if="$vuetify.breakpoint.md">
      <v-container class="pt-0" fluid  >
        <v-card-title
          style="position: absolute; top: -0px; left: 35px; width: 92%; border-radius: 3px; font-size: 14px;"
          class="primary white--text font-weight-regular red-gradient TitleCard"
        ...
        <v-card-actions class="d-flex justify-end px-4 py-0 mb-n10">
          <v-row class="py-0" style="margin:3%">
            <v-spacer></v-spacer>
            <v-col cols="12" class="pt-12">
              <v-text-field label="Search" light></v-text-field>
            </v-col>
    ...
    <!-- LARGE BREAKPOINT -->
    <v-card class="white pt-0 mt-12 mb-4" style="width: 100%; max-width: 1500px;" v-else-if="$vuetify.breakpoint.lg">
        <v-card-title
        ...
        >
              ...
              <template v-slot:item.phone="{ item }">{{ item.phone }}
    ...
    <!-- OTHER BREAKPOINT -->
    <v-card class="white pt-0 mt-12 mb-4" style="width: 100%; max-width: 1500px;" v-else>
        <v-card-title
          style="position: absolute; top: -30px; left: 25px; width: 30%; border-radius: 3px; font-size: 18px;"
          class="primary white--text font-weight-regular red-gradient TitleCard"
          >{{ title }}
