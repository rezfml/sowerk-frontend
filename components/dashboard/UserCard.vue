      ...
      <transition name="slide-fade">
        <v-card v-if="editStartLoad === true" class="mt-n8 d-flex flex-column align-center" style="width: 100%;">
          ...
          <v-form style="width: 80%;" class="d-flex flex-wrap justify-center">
            ...
            <v-checkbox style="width: 100%;" v-model="passwordCheckbox" label="Do you want to change your password? Check me!"></v-checkbox>
            <v-text-field v-if="passwordCheckbox" :type="'password'" v-model="userEditForm.password" :label="'Password'" class="mx-2" style="width: 40%; font-size: 18px;"></v-text-field>
  ...
  data() {
    return {
      ...
      headers: [
        ...
        { text: 'Primary Contact', value: 'full_name', class: 'primary--text font-weight-bold text-h6 text-left text-justify-start', sortable: false },
