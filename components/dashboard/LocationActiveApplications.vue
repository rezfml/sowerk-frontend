...
export default {
  ...
  data() {
    return {
      ...
      headers: [
        { text: 'Service', value: 'services', class: 'primary--text text-h6 font-weight-bold text-left' },
        { text: 'Company', value: 'companyName', class: 'primary--text text-h6 font-weight-bold text-left' },
        { text: 'Contact', value: 'full_name', class: 'primary--text text-h6 font-weight-bold text-left' },
        ...
        { text: 'Location', value: 'addressCityState', class: 'primary--text text-h6 font-weight-bold text-left' },
        { text: 'Co. History', value: 'yearFounded', class: 'primary--text text-h6 font-weight-bold text-left' },
        { text: 'Proximity', value: 'radius', class: 'primary--text text-h6 font-weight-bold text-left' },
        { text: 'Application Completed', value: 'applicationCompleted', class: 'primary--text text-h6 font-weight-bold text-left' },
